...
class BreakHisAnalyzer:
    ...
    def train_model(self, epochs=50, learning_rate=0.001, fusion_strategy='attention_weighted', batch_size=32):
...
training_configs = [
    {'fusion_strategy': 'attention_weighted', 'epochs': 40, 'lr': 0.0001, 'batch_size': 32},
    {'fusion_strategy': 'concatenate', 'epochs': 35, 'lr': 0.0001, 'batch_size': 32},
    {'fusion_strategy': 'separate_then_combine', 'epochs': 35, 'lr': 0.0001, 'batch_size': 32}
]
...
print(f"   Expected accuracy: ~{best_strategy[1]['accuracy']:.1f}%")

print("\n" + "="*80)
print("HYBRID BREAKHIS TRAINING COMPLETED SUCCESSFULLY!")
print("="*80)